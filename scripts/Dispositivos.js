...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (usuarioJSON) {
        ...
        // Función que obtiene los datos y actualiza la interfaz
        async function obtenerYActualizarFocos() {
            try {
        ...
        obtenerYActualizarFocos();

        // Repetir la actualización cada 10 segundos
        setInterval(obtenerYActualizarFocos, 10000);
